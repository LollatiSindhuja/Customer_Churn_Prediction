# Customer_Churn_Prediction using Supervised Machine Learning
...
# Performance Results:
# Logistic Regression :    
Accuracy = 0.801 (80.1%), Precision = 0.647, ROC-AUC = 0.840, Recall = 0.548, F1-Score = 0.593 
# Random Forest :
Accuracy = 0.799 (79.9%), Precision = 0.655, ROC-AUC = 0.837, Recall = 0.513, F1-Score = 0.576
